...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TechnicalAxos_EdgarGarnica.Android.dll" comes first in this list. */
		"TechnicalAxos_EdgarGarnica.Android.dll",
		"Acr.UserDialogs.dll",
		"AndHUD.dll",
		"DryIoc.dll",
		...
		"Prism.Forms.dll",
		"TechnicalAxos_EdgarGarnica.dll",
